...
#
# This script trains DINOv3-small on Food101 with 2 transformer blocks
#
...
#SBATCH --time=8:00:00
#SBATCH --mem=20G
#SBATCH --job-name=RC_2B_150E_FOOD101_DNV3_NM
#SBATCH --output=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_food101_dinov3_nm_%j.out
#SBATCH --error=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_food101_dinov3_nm_%j.err
