...
#
# This script trains DINOv3-base on FGVC Aircraft with 2 transformer blocks
#
...
#SBATCH --time=8:00:00
#SBATCH --mem=20G
#SBATCH --job-name=RC_2B_150E_FGVC_DNV3_BASE_NM
#SBATCH --output=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_fgvc_dinov3_base_nm_%j.out
#SBATCH --error=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_fgvc_dinov3_base_nm_%j.err
