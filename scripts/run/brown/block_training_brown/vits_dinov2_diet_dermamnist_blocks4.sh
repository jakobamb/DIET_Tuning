...
#
# This script trains DINOv2-small on DermaMNIST with 4 transformer blocks
#
...
#SBATCH --time=6:00:00
#SBATCH --mem=20G
#SBATCH --job-name=DIET_BLOCKS4_DERMA
#SBATCH --output=/data/people/jambsdor/DIET_Tuning/logs/diet_blocks4_derma_%j.out
#SBATCH --error=/data/people/jambsdor/DIET_Tuning/logs/diet_blocks4_derma_%j.err
