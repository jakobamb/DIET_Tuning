...
#SBATCH --time=6:00:00
#SBATCH --mem=20G
#SBATCH --job-name=DIET_BLOCKS2_DERMA
#SBATCH --output=/data/people/jambsdor/DIET_Tuning/logs/diet_blocks2_derma_%j.out
#SBATCH --error=/data/people/jambsdor/DIET_Tuning/logs/diet_blocks2_derma_%j.err
