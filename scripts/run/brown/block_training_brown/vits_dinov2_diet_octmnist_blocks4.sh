...
#
# This script trains DINOv2-small on OctMNIST with 4 transformer blocks
#
...
#SBATCH --time=6:00:00
#SBATCH --mem=20G
#SBATCH --job-name=DIET_BLOCKS4_OCT
#SBATCH --output=/data/people/jambsdor/DIET_Tuning/logs/diet_blocks4_oct_%j.out
#SBATCH --error=/data/people/jambsdor/DIET_Tuning/logs/diet_blocks4_oct_%j.err
