...
#
# This script trains DINOv3-base on PathMNIST with 2 transformer blocks
#
...
#SBATCH --time=8:00:00
#SBATCH --mem=20G
#SBATCH --job-name=RC_2B_150E_BASE_PATH_V3
#SBATCH --output=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_base_path_v3_%j.out
#SBATCH --error=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_base_path_v3_%j.err
