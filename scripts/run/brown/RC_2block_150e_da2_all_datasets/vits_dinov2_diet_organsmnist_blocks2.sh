...
#SBATCH --output=/data/people/jambsdor/DIET_Tuning/logs/rc_2b_150e_organs_%j.out
#SBATCH --error=/data/people/jambsdor/DIET_Tuning/logs/rc_2b_150e_organs_%j.err
