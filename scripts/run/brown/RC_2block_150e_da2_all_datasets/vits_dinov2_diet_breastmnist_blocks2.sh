...
#SBATCH --output=/data/people/jambsdor/DIET_Tuning/logs/rc_2b_150e_breast_%j.out
#SBATCH --error=/data/people/jambsdor/DIET_Tuning/logs/rc_2b_150e_breast_%j.err
