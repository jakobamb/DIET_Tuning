...
#SBATCH --output=/data/people/jambsdor/DIET_Tuning/logs/rc_2b_150e_retina_%j.out
#SBATCH --error=/data/people/jambsdor/DIET_Tuning/logs/rc_2b_150e_retina_%j.err
