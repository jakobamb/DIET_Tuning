...
# Ablation study: limit-data = 5000
#
...
#SBATCH --time=8:00:00
#SBATCH --mem=20G
#SBATCH --job-name=RC_2B_150E_BREAST_LIMIT5000
#SBATCH --output=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_breast_limit_5000_%j.out
#SBATCH --error=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_breast_limit_5000_%j.err
