...
#
# This script trains DINOv2-small on OrganSMNIST with 2 transformer blocks
...
#SBATCH --time=8:00:00
#SBATCH --mem=20G
#SBATCH --job-name=RC_2B_150E_organs_LIMIT10000
#SBATCH --output=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_organs_limit_10000_%j.out
#SBATCH --error=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_organs_limit_10000_%j.err
