...
#
# This script trains DINOv2-small on BreastMNIST with 2 transformer blocks
# Ablation study: limit-data = 10000
#
...
#SBATCH --time=8:00:00
#SBATCH --mem=20G
#SBATCH --job-name=RC_2B_150E_BREAST_LIMIT10000
#SBATCH --output=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_breast_limit_10000_%j.out
#SBATCH --error=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_breast_limit_10000_%j.err
...
srun python -u main.py \
    --wandb-prefix "RC_2block_150e_da2_medical_ablation" \
    --backbone dinov2 \
    --model-size small \
    --label-smoothing 0.2 \
    --da-strength 2 \
