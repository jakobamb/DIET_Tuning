...
#SBATCH --time=8:00:00
#SBATCH --mem=20G
#SBATCH --job-name=RC_2B_150E_FGVC_DNV3
#SBATCH --output=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_fgvc_dinov3_%j.out
#SBATCH --error=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_fgvc_dinov3_%j.err
