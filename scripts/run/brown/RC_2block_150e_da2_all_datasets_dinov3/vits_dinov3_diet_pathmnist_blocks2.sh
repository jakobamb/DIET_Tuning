...
#
# This script trains DINOv3-small on PathMNIST with 2 transformer blocks
#
...
#SBATCH --time=8:00:00
#SBATCH --mem=20G
#SBATCH --job-name=RC_2B_150E_PATH_V3
#SBATCH --output=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_path_v3_%j.out
#SBATCH --error=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_path_v3_%j.err
