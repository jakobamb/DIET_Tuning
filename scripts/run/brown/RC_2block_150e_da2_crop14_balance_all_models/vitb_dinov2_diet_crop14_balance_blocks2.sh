...
#
# This script trains DINOv2-base on Crop14 Balance with 2 transformer blocks
#
...
#SBATCH --time=8:00:00
#SBATCH --mem=20G
#SBATCH --job-name=RC_2B_150E_CROP14_BASE
#SBATCH --output=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_crop14_base_%j.out
#SBATCH --error=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_crop14_base_%j.err
...
srun python -u main.py \
    --wandb-prefix "RC_2block_150e_da2_crop14_balance" \
    --backbone dinov2 \
    --model-size base \
    --label-smoothing 0.2 \
    --da-strength 2 \
