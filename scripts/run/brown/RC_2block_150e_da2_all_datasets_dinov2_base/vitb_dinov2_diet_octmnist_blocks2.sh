...
#
# This script trains DINOv2-base on OctMNIST with 2 transformer blocks
#
...
#SBATCH --time=8:00:00
#SBATCH --mem=20G
#SBATCH --job-name=RC_2B_150E_BASE_OCT
#SBATCH --output=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_base_oct_%j.out
#SBATCH --error=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_base_oct_%j.err
