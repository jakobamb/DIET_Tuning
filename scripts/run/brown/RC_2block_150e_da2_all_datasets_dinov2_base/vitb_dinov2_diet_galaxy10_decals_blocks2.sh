...
#
# This script trains DINOv2-base on Galaxy10 DECaLS with 2 transformer blocks
#
...
#SBATCH --time=8:00:00
#SBATCH --mem=20G
#SBATCH --job-name=RC_2B_150E_GALAXY_BASE_NM
#SBATCH --output=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_galaxy_base_nm_%j.out
#SBATCH --error=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_galaxy_base_nm_%j.err
...
srun python -u main.py \
    --wandb-prefix "RC_2block_150e_da2_non_medical" \
    --backbone dinov2 \
    --model-size base \
    --label-smoothing 0.2 \
    --da-strength 2 \
