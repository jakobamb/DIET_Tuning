...
#
# This script trains DINOv2-base on PlantNet300K with 2 transformer blocks
#
...
#SBATCH --time=8:00:00
#SBATCH --mem=20G
#SBATCH --job-name=RC_2B_150E_PLANTNET_BASE
#SBATCH --output=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_plantnet_base_%j.out
#SBATCH --error=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_plantnet_base_%j.err
...
srun python -u main.py \
    --wandb-prefix "RC_2block_150e_da2_plantnet300k" \
    --backbone dinov2 \
    --model-size base \
    --label-smoothing 0.2 \
    --da-strength 2 \
