...
#
# This script trains DINOv2-small on PlantNet300K with 2 transformer blocks
#
...
#SBATCH --time=8:00:00
#SBATCH --mem=20G
#SBATCH --job-name=RC_2B_150E_PLANTNET
#SBATCH --output=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_plantnet_%j.out
#SBATCH --error=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_plantnet_%j.err
