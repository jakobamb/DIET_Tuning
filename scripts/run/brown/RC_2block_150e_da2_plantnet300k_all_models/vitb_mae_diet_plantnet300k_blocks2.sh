...
#
# This script trains MAE-base on PlantNet300K with 2 transformer blocks
#
...
#SBATCH --time=8:00:00
#SBATCH --mem=20G
#SBATCH --job-name=RC_2B_150E_PLANTNET_MAE
#SBATCH --output=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_plantnet_mae_%j.out
#SBATCH --error=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_plantnet_mae_%j.err
...
srun python -u main.py \
    --wandb-prefix "RC_2block_150e_da2_plantnet300k_mae" \
    --backbone mae \
    --model-size base \
    --label-smoothing 0.2 \
    --da-strength 2 \
