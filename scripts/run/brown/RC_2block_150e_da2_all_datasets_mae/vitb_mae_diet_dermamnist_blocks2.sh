...
#
# This script trains MAE-base on DermaMNIST with 2 transformer blocks
#
...
#SBATCH --time=8:00:00
#SBATCH --mem=20G
#SBATCH --job-name=RC_2B_150E_DERMA_MAE
#SBATCH --output=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_derma_mae_%j.out
#SBATCH --error=/home/jambsdor/projects/DIET_Tuning/logs/rc_2b_150e_derma_mae_%j.err
